                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        @if ($user->photo != null)
                                            ...
                                            <div class="col-3">
                                                <img src="{{ url('/storage/images/' . $user->photo) }}" width="65" height="70" />
                                            </div>
                                        @else
                                            <div class="col-12">
                                                <input type="file" name="photo" class="form-control" id="inputPhoto" />
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="datetimepickerDateOfBirth" data-target-input="nearest">
                                        <input type="text" name="date_of_birth" value="{{ old('date_of_birth', ($user->date_of_birth != null) ? $user->date_of_birth->format('d.m.Y') : '') }}" class="form-control datetimepicker-input" data-target="#datetimepickerDateOfBirth"/>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="card_number" class="form-control" id="inputCardNumber" minlength="1" maxlength="10" required value="{{ old('card_number', $user->card_number) }}" />

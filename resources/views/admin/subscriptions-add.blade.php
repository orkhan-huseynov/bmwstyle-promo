    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <form role="form" method="post" action="{{ url('/admin/subscriptions/') }}">
                        @csrf
                        {{ method_field('POST') }}
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="userId" class="form-control">
                                        ...
                                        @foreach($users as $user)
                                            <option value="{{ $user->id }}" @if (old('userId') == $user->id) selected @endif>{{ $user->name }} {{ $user->surname }} {{ $user->lastname }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="datetimepickerPeriod" data-target-input="nearest">
                                        <input type="text" name="period" value="{{ old('period') }}" class="form-control datetimepicker-input" data-target="#datetimepickerPeriod" readonly required />
                                ...
                                <div class="form-group">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input name="isVip" value="on" @if (old('isVip') == 'on') checked @endif class="form-check-input" type="checkbox"> VIP subscription
                                        </label>
                                    </div>
                                </div>
                            </div>
